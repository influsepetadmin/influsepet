...
export function PublicBrandProfileHeader({ data }: { data: PublicBrandProfileResponse }) {
  ...
  return (
    <header className="public-profile-hero public-profile-hero--brand">
        ...
        <div className="public-profile-hero__meta">
          ...
          {webHref ? (
            <p className="public-profile-hero__meta-line public-profile-hero__meta-line--web">
              <a href={webHref} target="_blank" rel="noopener noreferrer" className="public-profile-hero__web-link">
                Web sitesi
              </a>
            </p>
          ) : null}
